...
public class AddRecordDialog extends JDialog implements ActionListener {
	...
	public Container dialogPane() {
		...
		idField.setText(Integer.toString(recordDetails.getNextFreeId()));
		return empDetails;
	}
	...
	public void addRecord() {
		...
		currentEmployee = theEmployee;
		recordDetails.addRecord(theEmployee);
		displayRecords.displayRecords(theEmployee);
	}
	...
	public boolean checkInput() {
		...
		if (check.correctPps(this.ppsField.getText().trim(), -1)) {
			ppsField.setBackground(new Color(255, 150, 150));
			valid = false;
		} // end if
